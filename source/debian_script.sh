...
apt-get -y --no-install-recommends install ca-certificates procps psmisc iotop iftop lsof mc joe nano vim less telnet rsync curl tcpdump strace zip unzip bzip2 tar dnsutils netcat net-tools ss-dev iputils-ping inetutils-traceroute jq
apt-get -y clean
